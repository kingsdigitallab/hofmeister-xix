...
<!--+
    ...
    | 
    | CVS $Id: status2html.xslt 371229 2006-01-22 07:54:59Z antonio $
    +-->
  ...
  <xsl:template match="status:statusinfo">
    <html>
      <head>
        ...
        <link href="server-status/main.css" type="text/css" rel="stylesheet"/>
        <script src="server-status/main.js" type="text/javascript"/>
      </head>
